...
//assign br_inst  = inst_beq | inst_bne | inst_jirl | inst_bl | inst_b;
//assign br_taken = ((inst_beq &&  rj_eq_rd) ||
//                   (inst_bne && !rj_eq_rd) ||
//                    inst_jirl             ||
//                    inst_bl               ||
//                    inst_b) && ds_valid && ~load_stall;
//assign br_stall = br_inst && ds_valid && load_stall;
//assign br_target = (inst_beq || inst_bne || inst_bl || inst_b) ? (ds_pc + br_offs) :
//                                                                (rj_value + jirl_offs);

// ¼Ä´æÆ÷Ô´²Ù×÷ÊýÓÐÐ§ÐÔÅÐ¶Ï
assign src_no_rj = inst_b | inst_bl | inst_lu12i_w;
assign src_no_rk = inst_slli_w | inst_srli_w | inst_srai_w | inst_addi_w |
                   inst_ld_w | inst_st_w | inst_jirl | inst_b | inst_bl |
                   inst_beq | inst_bne | inst_lu12i_w;
...
// Í¨ÓÃ¼Ä´æÆ÷Ç°µÝ µÈ´ýÐÅºÅ
assign rj_wait = ~src_no_rj && (rj != 5'd0) &&
                 ((rj == es_to_ds_dest) || (rj == ms_to_ds_dest) || (rj == ws_to_ds_dest));
assign rkd_wait = (~src_no_rk || ~src_no_rd) && (rf_raddr2 != 5'd0) &&
                  ((rf_raddr2 == es_to_ds_dest) || (rf_raddr2 == ms_to_ds_dest) || (rf_raddr2 == ws_to_ds_dest));

// ¼Ä´æÆ÷È¡Öµ£ºÇ°µÝÓÅÏÈ¼¶ ES > MS > WS > ¼Ä´æÆ÷¶Ñ
assign rj_value = rj_wait ? 
                  ((rj == es_to_ds_dest) ? es_to_ds_result :
                   (rj == ms_to_ds_dest) ? ms_to_ds_result : ws_to_ds_result) : rf_rdata1;

assign rkd_value = rkd_wait ? 
                  ((rf_raddr2 == es_to_ds_dest) ? es_to_ds_result :
                   (rf_raddr2 == ms_to_ds_dest) ? ms_to_ds_result : ws_to_ds_result) : rf_rdata2;

// ===================== ÐÞ¸´LOADÔÝÍ££¨ºËÐÄ£©=====================
wire rj_use_ex  = ~src_no_rj && (rj != 5'd0) && (rj == es_to_ds_dest);
wire rkd_use_ex = (~src_no_rk || ~src_no_rd) && (rf_raddr2 != 5'd0) && (rf_raddr2 == es_to_ds_dest);
...
assign br_taken   = ((inst_beq &&  rj_eq_rd) ||
                     (inst_bne && !rj_eq_rd) ||
                      inst_jirl || inst_bl || inst_b) && ds_valid && ~load_stall;
assign br_stall   = br_inst && ds_valid && load_stall;
