...
parameter BASE_RAM_INIT_FILE = "X:/lab1.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "X:/lab1.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
...
begin
    if(~ext_ram_we_n)
    $display("    reference: data = 0x%8h, ext_ram_addr = 0x%8h",
                      ext_ram_data, ext_ram_addr);
end
